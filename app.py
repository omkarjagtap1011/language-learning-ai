...
# Authentication gate - Show public homepage for non-authenticated users
if not st.session_state.authenticated:
    ...
    signin_col1, signin_col2, signin_col3 = st.columns([1, 2, 1])
    with signin_col2:
        if not GOOGLE_CLIENT_ID or not GOOGLE_CLIENT_SECRET:
            st.error("""
            ...
            <div style="
                ...
                text-align: center;
            ">
                <h3 style="margin-bottom: 20px; color: #333;">Ready to Start Learning?</h3>
